...
const client = new Client('ws', host[0])
...
// Option 1: Direct OpenStreetMap tiles
//const mapTiles = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';

// Option 2: Single server OpenStreetMap tile
const mapTiles = 'https://b.tile.openstreetmap.org/{z}/{x}/{y}.png';

// Option 3: Local proxy for OpenStreetMap tiles (handles CORS issues)
// const mapTiles = 'http://localhost:3000/proxy/tiles/{s}/{z}/{x}/{y}.png';
